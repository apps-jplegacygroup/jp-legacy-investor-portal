          ...
          <div className="flex flex-col md:flex-row gap-6">
              ...
              return (
                <div className="md:w-80 flex-shrink-0">
                  <div className="relative rounded-xl overflow-hidden border border-white/10">
                    ...
                    <img src={mainImage} alt={`Propiedad ${property.city} ZIP ${property.zip}`} className="w-full h-52 object-cover" />
                    {property.ylopo_link && (
            ...
            <div className="flex-1">
              ...
              <h1 className="text-2xl md:text-3xl font-bold mb-1">
                {property.city}, {property.state} · ZIP {property.zip}
              </h1>
              <div className="flex items-center gap-2 mb-4 flex-wrap">
                <a
                  href={`https://wa.me/14076271966?text=${encodeURIComponent(`Hola, me interesa conocer la dirección completa de esta propiedad: ${typeof window !== 'undefined' ? window.location.href : ''} (ZIP ${property.zip}, ${property.city}, ${property.state} · ${fmtCurrency(Number(property.purchase_price))}). ¿Pueden brindarme una asesoría?`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 bg-green-500/20 hover:bg-green-500/30 border border-green-500/40 text-green-300 hover:text-green-200 font-semibold text-xs px-3 py-1.5 rounded-lg transition-colors"
                >
                  ...
                  {lang === 'en' ? 'Get full address' : 'Ver dirección completa'}
                </a>
              </div>
